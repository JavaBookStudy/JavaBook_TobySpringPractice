...
public class UserDaoTest {
	...
	public void setUp() {
		...
		user1 = new User("mylover", "park", "springno1", Level.BASIC, 1, 0, "taxol1203@naver.com");
		user2 = new User("taxol", "han", "springno2", Level.SILVER, 55, 10, "taxol1203@gamil.com");
		user3 = new User("opink", "park", "springno3", Level.GOLD, 100, 40, "taxol1203@daum.net");
